...
class TodayEventsViewController: UIViewController {
    ...
    func fetchData(){
        let url = URL(string: "http://www.wpoppin.com/api/events_today.json")
...
extension TodayEventsViewController: UITableViewDelegate, UITableViewDataSource {
