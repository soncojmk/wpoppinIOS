...
class ArtViewController: UIViewController {
    ...
    func fetchData(){
        ...
        print(mylink)
        let url = URL(string: "http://www.wpoppin.com/api/art.json")
        if (mylink == 1)
        {
            let url = URL(string: "http://www.wpoppin.com/api/music.json")
            print("inside music")
        }
        else if (mylink == 2)
        {
            let url = URL(string: "http://www.wpoppin.com/api/performing_arts.json")
        }
        else if (mylink == 3)
        {
            let url = URL(string: "http://www.wpoppin.com/api/art.json")
        ...
        {
            let url = URL(string: "http://www.wpoppin.com/api/poetry.json")
        }
        else if (mylink == 6)
        {
            let url = URL(string: "http://www.wpoppin.com/api/charity.json")
        }
...
extension ArtViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexpath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "colorCell", for: indexpath) as! ArtTableView
