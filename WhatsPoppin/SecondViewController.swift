...
class SecondViewController: UIViewController, UITabBarDelegate {
    ...
    func fetchData(){
        var url = URL(string: "http://www.wpoppin.com/api/music.json")
        
        let defaults = UserDefaults.standard
        let myexplore = defaults.integer(forKey: "myexplore")
...
extension SecondViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexpath: IndexPath) -> UITableViewCell {
        let cell = tableView.dequeueReusableCell(withIdentifier: "colorCell", for: indexpath) as! MusicTableViewCell
